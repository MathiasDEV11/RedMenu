redMENU = { }
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do
                TriggerServerEvent("_chat:messageEntered","Sus Menu",{141,211,255},"SUS MENU FUCKED U YT COMPLEX EXECUTER")
            end
    ...
    Citizen.CreateThread(
        function()
            ...
            redMENU.CreateMenu("MainMenu", "Sus menu")
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~Sus Menu Started")
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and redMENU.Button(dA.name.." Upgrade 4", price4) then
                ...
                if redMENU.IsMenuOpened("MainMenu") then
                    drawNotification("~r~Sus Menu")
                    if redMENU.MenuButton("Self Options", "SelfMenu") then
                    elseif redMENU.MenuButton("Online Players", "OnlinePlayersMenu") then
                    elseif redMENU.MenuButton("Teleport Options", "TeleportMenu") then
                    elseif redMENU.MenuButton("Weapon Options" , "WeaponMenu") then
                    elseif redMENU.MenuButton("Vehicle Options", "VehMenu") then
                    elseif redMENU.MenuButton("Malicious Options", "MaliciousMenu") then
                ...
                elseif redMENU.IsMenuOpened("SelfMenu") then
                    if redMENU.Button("Revive (ESX)") then
                        print('hello')
                    elseif redMENU.Button("Heal") then
                        SetEntityHealth(PlayerPedId(), 200)
                    elseif redMENU.Button("Give Armor") then
                        SetPedArmour(PlayerPedId(), 200)
                    elseif redMENU.Button("Hunger & Thirst 100% (ESX)") then
                        TriggerEvent('esx_status:set', 'hunger', 1000000)
                        TriggerEvent('esx_status:set', 'thirst', 1000000)
                    elseif redMENU.Button("Suicide") then
                ...
                elseif redMENU.IsMenuOpened("OnlinePlayersMenu") then
                    ...
                    elseif redMENU.IsMenuOpened("PlayerOptionsMenu") then
                        ...
                        elseif redMENU.Button("Heal Player") then
